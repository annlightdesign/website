...
export default function AboutSection({
  ...
  return (
    <section
      ref={containerRef}
      className={`relative w-full ${wallpaperUrl2 ? 'min-h-[100svh]' : 'min-h-[50svh] bg-background'} snap-start snap-always flex flex-col items-center justify-center p-8 pt-24 overflow-hidden`}
    >
