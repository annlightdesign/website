        ...
        {projects.map((project, idx) => {
          ...
          return (
            <div key={project.id} className={`flex flex-col lg:flex-row w-full bg-background border-b border-border/40 ${!isEven ? 'lg:flex-row-reverse' : ''}`}>
              ...
              <Link href={`/projects/${generateSlug(project.title)}`} prefetch={false} className="w-full lg:w-[55%] relative bg-muted group overflow-hidden min-h-[50vh] lg:min-h-[75vh] block flex-shrink-0">
